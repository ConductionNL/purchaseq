...
const config = createConfig({
  title: 'PurchaseQ',
  tagline: 'Procurement, supplier onboarding, and purchase orders on Nextcloud. Built on OpenRegister and the Conduction quality pipeline.',
  url: 'https://purchaseq.conduction.nl',
  baseUrl: '/',

  organizationName: 'ConductionNL',
  projectName: 'purchaseq',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://codeberg.org/Conduction/purchaseq/src/branch/main/docs/',
        },
        blog: false,
        theme: {
  ...
  navbar: {
    items: [
      ...
      {
        href: 'https://codeberg.org/Conduction/purchaseq',
        label: 'Codeberg',
        position: 'right',
      },
